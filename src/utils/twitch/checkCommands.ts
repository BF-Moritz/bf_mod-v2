import { getTwitchCommands } from '../../config/twitch/twitchConfig';
import { TwitchCommandsModuleInterface } from '../../interfaces/twitch/commands';

export async function checkCommands(eventName: string, eventModule: TwitchCommandsModuleInterface) {
...
async function checkCommandsConfig(eventName: string) {
